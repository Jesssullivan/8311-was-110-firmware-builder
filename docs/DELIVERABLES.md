...
| [`TIN-883`](https://linear.app/tinyland/issue/TIN-883/publish-signed-was-110-release-pack-from-pinned-inputs) | Publish signed WAS-110 release pack from pinned inputs | `.github/workflows/release-build.yml`, `audit/release-pack.sh`, `audit/verify-release-pack.sh`, `audit/provenance.sh` |
